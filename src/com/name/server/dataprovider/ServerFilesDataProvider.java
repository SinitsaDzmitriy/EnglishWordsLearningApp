...
public class ServerFilesDataProvider extends AServerFilesDataProvider {
    ...
    private final String DATA_STORAGE_DIR = "server";

    private static ServerFilesDataProvider instance;

    private ServerFilesDataProvider() {
        files = new File[NUM_OF_FILES];
        files[FIELDS] = new File(DATA_STORAGE_DIR + File.separator + "fields_of_cards.data");
        files[INDEX] = new File(DATA_STORAGE_DIR + File.separator + "index.data");
        files[ENG_SEARCH] = new File(DATA_STORAGE_DIR + File.separator + "eng_search.data");
        files[RUS_SEARCH] = new File(DATA_STORAGE_DIR + File.separator + "rus_search.data");
    }
